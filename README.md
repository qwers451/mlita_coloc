...
3. Перестановка: P => Q можно представить в виде NOT Q => NOT P. Это объясняется тем, что NOT P OR Q = Q OR NOT P.
4. P => NOT P можно представить в виде NOT P. NOT P =>  P можно представить в виде P. 
